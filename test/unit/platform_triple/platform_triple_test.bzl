...
def _construct_known_triples_test_impl(ctx):
    ...
    _assert_parts(env, triple("loongarch64-unknown-linux-gnu"), "loongarch64", "unknown", "linux", "gnu")
    _assert_parts(env, triple("loongarch64-unknown-none"), "loongarch64", "unknown", "none", None)
    _assert_parts(env, triple("sparc64-unknown-linux-gnu"), "sparc64", "unknown", "linux", "gnu")
