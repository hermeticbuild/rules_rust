...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.memchr-2.8.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.quote-1.0.45.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde-1.0.228",
        sha256 = "9a8e94ea7f378bd32cbbd37198a4a91436180c5bb472411e48b5ec2e2124ae9e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde/1.0.228/download"],
        strip_prefix = "serde-1.0.228",
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde-1.0.228.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde_core-1.0.228",
        sha256 = "41d385c7d4ca58e59fc732af25c3983b67ac852c1a25000afe1175de458b67ad",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_core/1.0.228/download"],
        strip_prefix = "serde_core-1.0.228",
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde_core-1.0.228.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde_derive-1.0.228",
        sha256 = "d540f220d3187173da220f885ab66608367b6574e925011a9353e4badda91d79",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_derive/1.0.228/download"],
        strip_prefix = "serde_derive-1.0.228",
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde_derive-1.0.228.bazel"),
    )

    maybe(
        http_archive,
        name = "rtvsc__serde_json-1.0.150",
        ...
        build_file = Label("//test/vscode/3rdparty/crates:BUILD.serde_json-1.0.150.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "rtvsc__serde_json-1.0.150", is_dev_dep = False),
    ]
