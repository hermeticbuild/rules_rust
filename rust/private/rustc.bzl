...
def rustc_compile_action(
    ...
    Returns:
        dict: A dict mapping provider names to provider instances. Keys include:
            - DefaultInfo: The output file for this crate, and its runfiles.
            - crate_info: CrateInfo for the crate we just built.
            - test_crate_info: TestCrateInfo for staticlib/cdylib crates.
            - dep_info: The transitive dependencies of this crate.
            - CcInfo: C/C++ interop info, if applicable.
            - AllocatorLibrariesImplInfo: Allocator library info, if applicable.
            - OutputGroupInfo: Additional output groups, if any.
            - LintsInfo: Lint configuration, if any.
    """
    ...
    for provider in establish_cc_info(ctx, attr, crate_info, toolchain, cc_toolchain, feature_configuration, interface_library):
        if type(provider) == "CcInfo":
            providers["CcInfo"] = provider
        else:
            providers["AllocatorLibrariesImplInfo"] = provider
